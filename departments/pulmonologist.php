...
@media (max-width: 768px) {
    ...
    ?>
        ...
        <h1 class="title">Pulmonologist</h1>
        <?php
    include_once "../includes/search.php";
    ?>
        <div class="container">
            <div class="doctor-card">
                <img src="..//img/OIP (14).jpg" alt="Dr. Khaled Al-Shafi">
                <h3>Dr. Khaled Al-Shafi</h3>
                <p>Experience: 20 years</p>
                <p>Brain and Neurology Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/download (7).jpg" alt="Dr. Ahmed Al-Mansouri">
                <h3>Dr. Ahmed Al-Mansouri</h3>
                <p>Experience: 14 years</p>
                <p>Neurological Care Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/OIP (24).jpg" alt="Dr. Laila Abdel-Hamid">
                <h3>Dr. Laila Abdel-Hamid</h3>
                <p>Experience: 18 years</p>
                <p>Specialized Neurology Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/OIP (25).jpg" alt="Dr. Sameh Mahmoud">
                <h3>Dr. Sameh Mahmoud</h3>
                <p>Experience: 12 years</p>
                <p>Modern Neuromedicine Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/OIP (26).jpg" alt="Dr. Farida Hassan">
                <h3>Dr. Farida Hassan</h3>
                <p>Experience: 10 years</p>
                <p>Spinal Cord Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/OIP (27).jpg" alt="Dr. Youssef Ismail">
                <h3>Dr. Youssef Ismail</h3>
                <p>Experience: 15 years</p>
                <p>Brain Health Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/OIP (28).jpg" alt="Dr. Rehab Al-Dessouki">
                <h3>Dr. Rehab Al-Dessouki</h3>
            ...
            <div class="doctor-card">
                <img src="..//img/OIP (29).jpg" alt="Dr. Yasser Al-Gendy">
                <h3>Dr. Yasser Al-Gendy</h3>
                <p>Experience: 13 years</p>
                <p>Advanced Neurology Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="..//img/OIP (30).jpg" alt="Dr. Samar Al-Hadidi">
                <h3>Dr. Samar Al-Hadidi</h3>
                <p>Experience: 9 years</p>
                <p>Brain and Neurological Health Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
        </div>
