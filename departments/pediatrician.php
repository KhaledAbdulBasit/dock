...
<?php
    ...
    <h1 class="title">Pediatric Doctors</h1>
    <?php
    ...
    <div class="container">
        ...
        <div class="doctor-card">
            <img src="..//img/download (10).jpg" alt="Dr. Ahmed Hassan">
            <h3>Dr. Ahmed Hassan</h3>
            <p>Experience: 20 years</p>
            <p>Children's Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/download (9).jpg" alt="Dr. Laila Mostafa">
            <h3>Dr. Laila Mostafa</h3>
            <p>Experience: 15 years</p>
            <p>Specialized Children's Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (40).jpg" alt="Dr. Sami Abdullah">
            <h3>Dr. Sami Abdullah</h3>
            <p>Experience: 18 years</p>
            <p>Infants and Children's Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (39).jpg" alt="Dr. Hind Youssef">
            <h3>Dr. Hind Youssef</h3>
            <p>Experience: 14 years</p>
            <p>Children's Health Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (41).jpg" alt="Dr. Mostafa Abdel Karim">
            <h3>Dr. Mostafa Abdel Karim</h3>
            <p>Experience: 12 years</p>
            <p>Modern Pediatric Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (43).jpg" alt="Dr. Nada Abdel Aziz">
            <h3>Dr. Nada Abdel Aziz</h3>
            <p>Experience: 10 years</p>
            <p>Children's and Primary Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (42).jpg" alt="Dr. Yahia Mahmoud">
            <h3>Dr. Yahia Mahmoud</h3>
            <p>Experience: 16 years</p>
            <p>Happy Childhood Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.phpl';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (44).jpg" alt="Dr. Rania Hassan">
            <h3>Dr. Rania Hassan</h3>
        ...
        <div class="doctor-card">
            <img src="..//img/OIP (45).jpg" alt="Dr. Youssef Ibrahim">
            <h3>Dr. Youssef Ibrahim</h3>
            <p>Experience: 13 years</p>
            <p>Integrated Children's Health Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
