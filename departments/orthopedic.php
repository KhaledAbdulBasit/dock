...
<?php
    ...
    <h1 class="title">Orthopedic Surgeon</h1>
    <?php
    include_once "../includes/search.php";
    ?>
    <div class="container">
        <div class="doctor-card">
            <img src="..//img/OIP (46).jpg" alt="Dr. Ahmed Salem">
            <h3>Dr. Ahmed Salem</h3>
            <p>Experience: 20 years</p>
            <p>Specialized Orthopedic Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/download (11).jpg" alt="Dr. Fatima El-Shenawy">
            <h3>Dr. Fatima El-Shenawy</h3>
            <p>Experience: 15 years</p>
            <p>Orthopedic and Surgery Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (47).jpg" alt="Dr. Samer Khalil">
            <h3>Dr. Samer Khalil</h3>
            <p>Experience: 18 years</p>
            <p>Orthopedic and Fracture Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (48).jpg" alt="Dr. Gaber Ali">
            <h3>Dr. Gaber Ali</h3>
            <p>Experience: 14 years</p>
            <p>Bone Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/download (12).jpg" alt="Dr. Mostafa El-Dasouqi">
            <h3>Dr. Mostafa El-Dasouqi</h3>
            <p>Experience: 12 years</p>
            <p>Advanced Orthopedic Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (50).jpg" alt="Dr. Nada Shawky">
            <h3>Dr. Nada Shawky</h3>
            <p>Experience: 10 years</p>
            <p>Precision Orthopedic and Surgery Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (51).jpg" alt="Dr. Yahya Mansour">
            <h3>Dr. Yahya Mansour</h3>
            <p>Experience: 16 years</p>
            <p>Sports Injury Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (49).jpg" alt="Dr. Rania Hussein">
            <h3>Dr. Rania Hussein</h3>
            <p>Experience: 19 years</p>
            <p>Orthopedic and Spine Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/download (13).jpg" alt="Dr. Youssef Nabil">
            <h3>Dr. Youssef Nabil</h3>
            <p>Experience: 13 years</p>
            <p>Fracture and Physical Therapy Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
    </div>
