...
$sql = "SELECT d.name , d.icon, d.description FROM departments d WHERE d.id = ?";
...
$sql = "SELECT id,name,specialization,image,experience_years FROM doctors WHERE department_id   = ? LIMIT 10";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $department_id);
$stmt->execute();
...
<head>
    ...
    <title><?= htmlspecialchars(string: $department['name']) ?></title>
...
<?php
  ...
  <h1 class="title"><?= htmlspecialchars(string: $department['name']) ?></h1>
    ...
    <?php while ($doctor = $doctors->fetch_assoc()):?>
        <div class="doctor-card">
            ...
            <a class="book-btn" href='book.php?id=<?= htmlspecialchars($doctor['id'])?>'>Book Appointment</a>
        </div>
        ...
        <div class="doctor-card">
            <img src="..//img/OIP (53).jpg" alt="Dr. Laila Hassan">
            <h3>Dr. Laila Hassan</h3>
            <p>Experience: 15 years</p>
            <p>Urological Diseases Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/download (15).jpg" alt="Dr. Sami Abdelghaffar">
            <h3>Dr. Sami Abdelghaffar</h3>
            <p>Experience: 18 years</p>
            <p>Kidney and Urology Health Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/download (18).jpg" alt="Dr. Hind Salama">
            <h3>Dr. Hind Salama</h3>
            <p>Experience: 14 years</p>
            <p>Urological Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/download (15).jpg" alt="Dr. Mostafa Kamal">
            <h3>Dr. Mostafa Kamal</h3>
            <p>Experience: 12 years</p>
            <p>Urological Treatment Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (54).jpg" alt="Dr. Adam Ali">
            <h3>Dr. Adam Ali</h3>
            <p>Experience: 10 years</p>
            <p>Kidney and Urinary System Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/download (14).jpg" alt="Dr. Yehia Mahmoud">
            <h3>Dr. Yehia Mahmoud</h3>
            <p>Experience: 16 years</p>
            <p>Specialized Urology Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/OIP (55).jpg" alt="Dr. Rania Abdelsalam">
            <h3>Dr. Rania Abdelsalam</h3>
            <p>Experience: 19 years</p>
            <p>Urological Disorders Treatment Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>

        <div class="doctor-card">
            <img src="..//img/download (16).jpg" alt="Dr. Youssef Abdullah">
            <h3>Dr. Youssef Abdullah</h3>
            <p>Experience: 13 years</p>
            <p>Urology Health Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
