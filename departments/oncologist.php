...
<?php
    ...
    ?>
    <h1 class="title">Oncologists</h1>
    <?php
    include_once "../includes/search.php";
    ?>
    <div class="container">
        <div class="doctor-card">
            <img src="..//img/OIP (31).jpg" alt="Dr. Yasser Mahmoud">
            <h3>Dr. Yasser Mahmoud</h3>
            <p>Experience: 22 years</p>
            <p>Oncology Treatment Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/download (8).jpg" alt="Dr. Hala Samir">
            <h3>Dr. Hala Samir</h3>
            <p>Experience: 18 years</p>
            <p>Modern Cancer Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (32).jpg" alt="Dr. Karim Abdel Aleem">
            <h3>Dr. Karim Abdel Aleem</h3>
            <p>Experience: 15 years</p>
            <p>Specialized Oncology Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (34).jpg" alt="Dr. Sahar El-Dessouki">
            <h3>Dr. Sahar El-Dessouki</h3>
            <p>Experience: 14 years</p>
            <p>Hope Oncology Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (33).jpg" alt="Dr. Nabil Hassan">
            <h3>Dr. Nabil Hassan</h3>
            <p>Experience: 12 years</p>
            <p>Life Oncology Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (36).jpg" alt="Dr. Yomna Abdel Ghaffar">
            <h3>Dr. Yomna Abdel Ghaffar</h3>
            <p>Experience: 10 years</p>
            <p>Advanced Oncology Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (38).jpg" alt="Dr. Hossam El-Sharkawy">
            <h3>Dr. Hossam El-Sharkawy</h3>
            <p>Experience: 16 years</p>
            <p>Hope and Recovery Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (35).jpg" alt="Dr. Laila Ibrahim">
            <h3>Dr. Laila Ibrahim</h3>
            <p>Experience: 19 years</p>
            <p>Cancer Treatment Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (37).jpg" alt="Dr. Sami Rashid">
            <h3>Dr. Sami Rashid</h3>
            <p>Experience: 13 years</p>
            <p>Hope Oncology Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
    </div>
