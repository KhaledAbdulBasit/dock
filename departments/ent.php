...
<?php
    ...
    <h1 class="title">ENT Specialist</h1>
    <?php
    include_once "../includes/search.php";
    ?>
    <div class="container">
        <div class="doctor-card">
            <img src="..//img/OIP (69).jpg" alt="Dr. Ahmed Hassan">
            <h3>Dr. Ahmed Hassan</h3>
            <p>Experience: 18 years</p>
            <p>Advanced ENT Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (68).jpg" alt="Dr. Laila Mahmoud">
            <h3>Dr. Laila Mahmoud</h3>
            <p>Experience: 15 years</p>
            <p>Hearing and Balance Treatment Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (71).jpg" alt="Dr. Sami Abdelaziz">
            <h3>Dr. Sami Abdelaziz</h3>
            <p>Experience: 20 years</p>
            <p>Cosmetic Ear Surgery Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (70).jpg" alt="Dr. Hind Youssef">
            <h3>Dr. Hind Youssef</h3>
            <p>Experience: 14 years</p>
            <p>Modern ENT Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/download (24).jpg" alt="Dr. Mostafa Kamal">
            <h3>Dr. Mostafa Kamal</h3>
            <p>Experience: 12 years</p>
            <p>ENT Surgery Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (72).jpg" alt="Dr. Nada Fouad">
            <h3>Dr. Nada Fouad</h3>
        ...
        <div class="doctor-card">
            <img src="..//img/OIP (73).jpg" alt="Dr. Yahya Mahmoud">
            <h3>Dr. Yahya Mahmoud</h3>
            <p>Experience: 16 years</p>
            <p>ENT Diseases Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (74).jpg" alt="Dr. Rania Abdelsalam">
            <h3>Dr. Rania Abdelsalam</h3>
            <p>Experience: 19 years</p>
            <p>Hearing and Balance Center</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (75).jpg" alt="Dr. Youssef Abdullah">
            <h3>Dr. Youssef Abdullah</h3>
            <p>Experience: 13 years</p>
            <p>ENT Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
    </div>
