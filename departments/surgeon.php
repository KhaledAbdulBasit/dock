    ...
    ?>
        <div class="container">
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/download (22).jpg" alt="Dr. Ahmed Kamal">
                <h3>Dr. Ahmed Kamal</h3>
                <p>Experience: 20 years</p>
                <p>Advanced Surgery Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/download (21).jpg" alt="Dr. Leila Mahmoud">
                <h3>Dr. Leila Mahmoud</h3>
                <p>Experience: 15 years</p>
                <p>Precision Surgery Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/OIP (64).jpg" alt="Dr. Sami Abdelhamid">
                <h3>Dr. Sami Abdelhamid</h3>
                <p>Experience: 18 years</p>
                <p>General Surgery Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/OIP (62).jpg" alt="Dr. Hend Sherif">
                <h3>Dr. Hend Sherif</h3>
                <p>Experience: 14 years</p>
                <p>Advanced Operations Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/download (22).jpg" alt="Dr. Mostafa Zidan">
                <h3>Dr. Mostafa Zidan</h3>
                <p>Experience: 12 years</p>
                <p>Modern Surgery Center</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/OIP (65).jpg" alt="Dr. Nada Omar">
                <h3>Dr. Nada Omar</h3>
                <p>Experience: 10 years</p>
                <p>Specialized Surgery Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/OIP (66).jpg" alt="Dr. Yehia Abdelsalam">
                <h3>Dr. Yehia Abdelsalam</h3>
                <p>Experience: 16 years</p>
                <p>Emergency Surgery Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/OIP (68).jpg" alt="Dr. Rania El Gendy">
                <h3>Dr. Rania El Gendy</h3>
                <p>Experience: 19 years</p>
                <p>Comprehensive Surgery Hospital</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
            <div class="doctor-card">
                <img src="<?= BASE_URL ?>img/OIP (67).jpg" alt="Dr. Youssef Samir">
                <h3>Dr. Youssef Samir</h3>
                <p>Experience: 13 years</p>
                <p>Global Surgery Center</p>
                <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
            </div>
        </div>
