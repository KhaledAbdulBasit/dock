...
<?php
  ...
  <h1 class="title">cardiologist</h1>
  <?php
   ...
   <div class="container">
        ...
        <div class="doctor-card">
            <img src="../img/OIP (77).jpg" alt="Dr. Ahmed Ali">
            <h3>Dr. Ahmed Ali</h3>
            <p>Experience: 15 years</p>
            <p>Al-Nile Hospital</p>
        ...
        <!-- Doctor 2 -->
        <div class="doctor-card">
            <img src="../img/OIP (78).jpg" alt="Dr. Mohamed Nabil">
            <h3>Dr. Mohamed Nabil</h3>
        ...
        <!-- Doctor 3 -->
        <div class="doctor-card">
            <img src="../img/download.jpg" alt="Dr. Khaled Hassan">
            <h3>Dr. Khaled Hassan</h3>
            <p>Experience: 12 years</p>
            <p>Al-Amal Hospital</p>
        ...
        <!-- Doctor 4 -->
        <div class="doctor-card">
            <img src="../img/OIP (76).jpg" alt="Dr. Laila Samir">
            <h3>Dr. Laila Samir</h3>
        ...
        <!-- Doctor 5 -->
        <div class="doctor-card">
            <img src="../img/download (25).jpg" alt="Dr. Amr Youssef">
            <h3>Dr. Amr Youssef</h3>
        ...
        <!-- Doctor 6 -->
        <div class="doctor-card">
            <img src="../img/download (1).jpg" alt="Dr. Nada Ibrahim">
            <h3>Dr. Nada Ibrahim</h3>
        ...
        <!-- Doctor 7 -->
        <div class="doctor-card">
            <img src="../img/download (2).jpg" alt="Dr. Youssef Ahmed">
            <h3>Dr. Youssef Ahmed</h3>
        ...
        <!-- Doctor 8 -->
        <div class="doctor-card">
            <img src="../img/OIP (80).jpg" alt="Dr. Mona Khalil">
            <h3>Dr. Mona Khalil</h3>
        ...
        <!-- Doctor 9 -->
        <div class="doctor-card">
            <img src="../img/OIP (79).jpg" alt="Dr. Sami Abdullah">
