...
<?php
    ...
    <h1 class="title">Gynaecologist</h1>
    <?php
    include_once "../includes/search.php";
    ?>
    <div class="container">
        <div class="doctor-card">
            <img src="..//img/OIP (21).jpg" alt="Dr. Hala Mostafa">
            <h3>Dr. Hala Mostafa</h3>
            <p>Experience: 18 years</p>
            <p>Mother and Child Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (23).jpg" alt="Dr. Samir Abdel Halim">
            <h3>Dr. Samir Abdel Halim</h3>
            <p>Experience: 12 years</p>
            <p>Women's Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (17).jpg" alt="Dr. Mona El-Sayed">
            <h3>Dr. Mona El-Sayed</h3>
            <p>Experience: 15 years</p>
            <p>Modern Maternity Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (16).jpg" alt="Dr. Khaled Mahmoud">
            <h3>Dr. Khaled Mahmoud</h3>
            <p>Experience: 10 years</p>
            <p>Hope Women's Health Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (15).jpg" alt="Dr. Fatma El-Gendy">
            <h3>Dr. Fatma El-Gendy</h3>
            <p>Experience: 14 years</p>
            <p>Life Women's Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (18).jpg" alt="Dr. Yahia El-Naggar">
            <h3>Dr. Yahia El-Naggar</h3>
            <p>Experience: 11 years</p>
            <p>Kind Mother Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (20).jpg" alt="Dr. Iman Abdel Aziz">
            <h3>Dr. Iman Abdel Aziz</h3>
            <p>Experience: 17 years</p>
            <p>Happiness Women's Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.phpl';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (19).jpg" alt="Dr. Mahmoud El-Sharkawy">
            <h3>Dr. Mahmoud El-Sharkawy</h3>
            <p>Experience: 9 years</p>
            <p>Safe Motherhood Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (22).jpg" alt="Dr. Sahar Alawi">
            <h3>Dr. Sahar Alawi</h3>
            <p>Experience: 13 years</p>
            <p>Mother and Fetus Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href='book.php';">Book Appointment</button>
        </div>
    </div>
