...
<?php
    ...
    <h1 class="title">Dermatologists</h1>
    <?php
    include_once "../includes/search.php";
    ?>
    <div class="container">
        <div class="doctor-card">
            <img src="..//img/OIP (7).jpg" alt="Dr. Leila Abdelrahman">
            <h3>Dr. Leila Abdelrahman</h3>
            <p>Experience: 15 years</p>
            <p>Dermatology and Aesthetics Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (13).jpg" alt="Dr. Ahmed Fouad">
            <h3>Dr. Ahmed Fouad</h3>
            <p>Experience: 10 years</p>
            <p>Skin Care Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (9).jpg" alt="Dr. Nada Hassan">
            <h3>Dr. Nada Hassan</h3>
            <p>Experience: 12 years</p>
            <p>Rejuvenation and Beauty Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/download (5).jpg" alt="Dr. Kareem Mahmoud">
            <h3>Dr. Kareem Mahmoud</h3>
            <p>Experience: 9 years</p>
            <p>Healthy Skin Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (8).jpg" alt="Dr. Suad Youssef">
            <h3>Dr. Suad Youssef</h3>
            <p>Experience: 8 years</p>
            <p>Everlasting Youth Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (12).jpg" alt="Dr. Emad Hamdy">
            <h3>Dr. Emad Hamdy</h3>
            <p>Experience: 11 years</p>
            <p>Beauty and Dermatology Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (10).jpg" alt="Dr. Rehab Shawky">
            <h3>Dr. Rehab Shawky</h3>
        ...
        <div class="doctor-card">
            <img src="..//img/download (6).jpg" alt="Dr. Yasser Abdullah">
            <h3>Dr. Yasser Abdullah</h3>
            <p>Experience: 13 years</p>
            <p>Radiant Skin Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>

        </div>
        <div class="doctor-card">
            <img src="..//img/OIP (11).jpg" alt="Dr. Samar Ahmed">
            <h3>Dr. Samar Ahmed</h3>
            <p>Experience: 6 years</p>
            <p>Light and Purity Hospital</p>
            <div class="rating">★★★★★ 4.7</div>
            <button class="book-btn" onclick="window.location.href= 'book.php';" >Book Appointment</button>
